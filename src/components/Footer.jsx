      ...
      <div className="container">
        ...
        <div className="footer__grid">
          ...
          <div className="footer__brand">
            ...
            <p className="footer__tagline">
              Premium done-for-you websites for businesses that want to grow — without the tech headache.
            </p>
            <Link to="/request" className="btn btn--primary btn--sm footer__cta">
              <Zap size={14} /> Start Your Project
            </Link>
            {/* Socials */}
        ...
        <div className="footer__bottom">
          <p className="footer__copy">
            © {new Date().getFullYear()} Pixora. All rights reserved. Built with ❤️ in India.
          </p>
          <motion.button
