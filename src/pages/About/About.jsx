      ...
      <section className="section">
        <div className="container">
          <div className="grid-2">
            <ScrollAnimator animation="from-left" style={{ display: 'grid' }}>
            ...
            <ScrollAnimator animation="from-right" style={{ display: 'grid' }}>
              <div className="card" style={{ display: 'flex', flexDirection: 'column' }}>
      ...
      <section className="section bg-frost" style={{ background: 'var(--color-frost)' }}>
        <div className="container">
          ...
          <div className="grid-3">
            {values.map((v, i) => (
              <ScrollAnimator key={i} animation="from-bottom" delay={`delay-${(i % 3) + 1}`} style={{ display: 'grid' }}>
